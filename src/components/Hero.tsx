        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-16 animate-fade-up [animation-delay:0.6s] opacity-0 animate-[fade-up_0.8s_ease-out_0.6s_both]">
            ...
            <button
              ...
              className="px-8 py-3 border border-tertiary text-tertiary font-mono font-medium rounded-lg hover:bg-tertiary/10 hover:shadow-glow-tertiary transition-all duration-300 hover:-translate-y-1"
            >
              Get In Touch
            </button>
          </div>
